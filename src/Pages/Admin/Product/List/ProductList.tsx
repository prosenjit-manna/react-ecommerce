          ...
          <tr>
            ...
            <td className='align-middle'>
              <div className='img-container'>
                <img src='https://place-hold.it/400' alt='product' className='img-fluid' width='120' height='120' />
              </div>
            </td>
            <td className='align-middle'>T-shirt</td>
            <td className='align-middle'>$49.99</td>
            <td className='align-middle text-end'>
              <Link to={routes.admin.product.edit.build('12')} className='btn btn-primary'>
                Edit
              </Link>
